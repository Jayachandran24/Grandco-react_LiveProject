            ...
            <div className="clumn">
              ...
              <div className="social circle-bord mt-30">
                <ul className="rest horizontal-link">
                  <li>
                    <a href={footerData.social_links.facebook} target='_blank' rel="noreferrer noopener"><i className="fab fa-facebook-f"></i></a>
                    <a href={footerData.social_links.twitter} className="ms-1" target='_blank' rel="noreferrer noopener"><i className="fab fa-twitter"></i></a>
                    <a href={footerData.social_links.instagram} className="ms-1" target='_blank' rel="noreferrer noopener"><i className="fab fa-instagram"></i></a>
