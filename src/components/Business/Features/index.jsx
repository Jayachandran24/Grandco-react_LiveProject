        ...
        <div className="row">
          <div className={`col-lg-4 ${services ? '' : 'col-md-6'} valign`}>
            <div className="exp">
              {
                services ?
                  <h2 className="fw-600">We simplify payments for business owners</h2>
                  :
                  <h3 className="fw-700">We simplify payments <span className="fw-300">for business owners</span></h3>
              }
            </div>
          </div>
          <div className={`col-lg-4 ${services ? '' : 'col-md-6'} valign`}>
        ...
        <div className="row" style={{ justifyContent: 'center' }}>
          {
            features.feats.map((feature, idx) => (
              services ?
                (
                  <div key={idx} className="col-lg-4 col-md-6 hover3d">
                ...
                (
                  <Tilt key={idx} className="col-lg-3 col-md-6 hover3d" tiltMaxAngleY={10} tiltMaxAngleX={10}>
                    <div className="feat-item-img hover3d-child bg-img d-flex" style={{ backgroundImage: `url('${feature.bg}')` }} data-overlay-dark="4">
                      <div className="num">{feature.numb}</div>
                      <div className="cont">
                        <span className="fz-14 opacity-8 mb-5 d-none">{feature.title}</span>
                        <h6 className="fz-20" style={{}}>{feature.type}</h6>
                      </div>
                    </div>
                  </Tilt>
                )
